...
def main(args):
    ...
    # Mixed model
    args.load_model_path = os.environ["HOME"]+ "/random/rl/openai_logs/openai-remi/"

    # Alpha .5
    # args.load_model_path = os.path.join( args.load_model_path, "mixedLossAlpha0_5_20180926/checkpoint/torcs_remi/torcs_remi_2350")
